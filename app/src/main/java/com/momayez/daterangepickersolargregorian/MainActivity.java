...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Typeface face = Typeface.createFromAsset(getAssets(), "iran_sans.ttf");

        FragmentManager fragmentManager = getSupportFragmentManager();
        DateRangePicker persianDateRangePicker = new DateRangePicker()
        ...
        persianDateRangePicker.show(fragmentManager, persianDateRangePicker.getTag());


//        FragmentManager fragmentManager = getSupportFragmentManager();
//        DatePicker persianDateRangePicker = new DatePicker()
